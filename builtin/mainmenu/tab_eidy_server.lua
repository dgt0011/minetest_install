...
local function get_formspec(tabview, name, tabdata)
	...
	local retval =
		"button[4,4.15;2.0,0.5;world_delete;" .. fgettext("Delete") .. "]" ..
		"button[6.0,4.15;2.0,0.5;world_create;" .. fgettext("New") .. "]" ..
		"button[8.2,4.15;2.0,0.5;world_configure;" .. fgettext("Configure") .. "]" ..
...
--		dump(core.setting_getbool("server_announce")) .. "]" ..
		"label[0.25,-0.2;" .. fgettext("Name") .. "]" ..
		"field[0.55,0.8;3.5,0.5;te_playername;;" ..
